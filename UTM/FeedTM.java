...
class FeedTM {
	...
	public static void main(String[] args) throws Exception {
       ...
       */
			...
			System.out.println("La nueva cinta es: " + NuevaCinta);
			PrintStream PProc = new PrintStream(new FileOutputStream(new File("Procesada.txt")));
			PProc.println(NuevaCinta);
			System.out.println("\nNueva cinta esta en \"Procesada.txt\"");
		} //endFor
	} //endMain
} //endClass
